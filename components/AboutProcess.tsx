export default function AboutProcess() {
  return (
    <section className="bg-[#1a191b] text-white px-5 py-[100px] font-league max-w-[1100px] mx-auto">
      {/* Step 01 */}
      <div className="flex flex-wrap items-start mb-20">
        <div className="text-[#cfb580] text-6xl font-bold w-[100px] leading-none flex-shrink-0 mb-2 sm:mb-0">
          01
        </div>
        <div className="flex-1 pl-5 sm:pl-0">
          <div className="text-[#cfb580] text-[2.625rem] font-bold uppercase tracking-wide mb-3 sm:text-[2rem]">
            Growth
          </div>
