...
export default function UGCPage() {
    ...
    const [playingStates, setPlayingStates] = useState<boolean[]>(Array(reels.length).fill(false));
    ...
    return (
        <main className="bg-[#1a191b] text-[#cfb580] font-league">
            ...
            <section className="h-screen flex flex-col justify-center items-center text-center px-6">
                ...
                >
                   Performace UGC That Converts
                </motion.h1>
                <motion.p
                    className="text-3xl max-w-xxl text-[#cfb580]/80"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.3, duration: 0.6 }}
                >
                    We understand your brand identity and how to make your content resonate with your viewers that acuatlly generates conversions.
                </motion.p>
            </section>
                    ...
                    {reels.map((reel, index) => (
                        <div key={index} className="flex flex-col items-center w-full max-w-[400px]">
                            ...
                            <div className="mb-3 text-center">
                                ...
                                <p className="text-2xl text-[#cfb580]/70 text-center mt-1">
                                    {reel.views} views
                                </p>
                            </div>
                            ...
                            <div className="relative w-full aspect-[9/16] rounded-3xl overflow-hidden border border-[#cfb580]/30 shadow-lg group">
                                ...
                                {!playingStates[index] && (
                                    <div
                                        className="absolute inset-0 flex items-center justify-center bg-gradient-to-t from-black/40 to-transparent cursor-pointer"
