const photos = [
  { src: 'https://lhmcollective.b-cdn.net/Work%20Photos/Cuisinart/Cuisinart-4-lighthouse-media-dallas-based-videographer.png', alt: 'Cuisinart product photo 1' },
  { src: 'https://lhmcollective.b-cdn.net/Work%20Photos/Cuisinart/Cuisinart-3-light-house-media-dallas-videographer.png', alt: 'Cuisinart product photo 2' },
  { src: 'https://lhmcollective.b-cdn.net/Work%20Photos/Cuisinart/Cuisinart-replacement-lighthousemedia-dallas-videographer-photographer.png', alt: 'Cuisinart product photo 3' },
  { src: 'https://lhmcollective.b-cdn.net/Work%20Photos/Cuisinart/Cuisinart-1-lighthousemedia-dallas-videographer.png', alt: 'Cuisinart product photo 4' },
];
    ...
    <div className="bg-[#1a191b] text-[#cfb580] min-h-screen">
      ...
      <section className="border-y border-[#cfb580]/15 py-12 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6 text-center">
          <div>
            <p className="text-4xl sm:text-5xl md:text-6xl font-bold">National</p>
            <p className="mt-2 text-[10px] uppercase tracking-[0.22em] text-[#cfb580]/40">Brand</p>
          </div>
          <div>
            <p className="text-4xl sm:text-5xl md:text-6xl font-bold">2021</p>
            <p className="mt-2 text-[10px] uppercase tracking-[0.22em] text-[#cfb580]/40">Campaign Year</p>
          </div>
          <div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-20 md:py-28 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold leading-snug">
            Premium visuals for an iconic kitchen brand.
          </h2>
        </div>
        <div className="text-[#cfb580]/70 text-base leading-relaxed space-y-5">
          <p>
            In 2021, we partnered with Cuisinart, a leading name in culinary tools and kitchen innovation, on a product launch video campaign.
          </p>
          <p>
            Shot in Dallas, Texas, the campaign was produced in collaboration with Area Code agency and directed alongside our friend Colin Conley. Our role focused on videography — producing multiple promotional videos that showcased the product&rsquo;s design, features, and lifestyle appeal in a way that felt fresh and accessible.
          </p>
          <p>
            Known for empowering home cooks and food lovers with reliable, stylish appliances, Cuisinart&rsquo;s legacy made this project a unique opportunity to blend premium visuals with everyday functionality — helping bring their brand to life through content built for modern platforms.
          </p>
        </div>
      </section>
