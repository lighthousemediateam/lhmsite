    ...
    <div className="bg-[#1a191b] text-[#cfb580] min-h-screen">
      ...
      <div className="max-w-3xl mx-auto mt-10 px-6 text-center">
        ...
        <p className="text-[#cfb580]/90 text-base leading-relaxed">
          REIGN Storm, the lifestyle-centric counterpart to REIGN Body Fuel, targets a broader, more style-conscious audience. For REIGN Storm, we focus on visually compelling, socially native content that blends fitness with fashion, energy, and edge.
          <br className="hidden sm:block" />
          <br />
          Our team handles both content direction and production, ensuring every piece feels authentic to the brand while staying optimized for engagement on platforms like TikTok and Instagram.
          <br className="hidden sm:block" />
          <br />
