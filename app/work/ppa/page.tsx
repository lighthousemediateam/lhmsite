    ...
    <div className="bg-[#1a191b] text-[#cfb580] min-h-screen">
      ...
      <section className="border-y border-[#cfb580]/15 py-12 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6 text-center">
          <div>
            <p className="text-4xl sm:text-5xl md:text-6xl font-bold">Event</p>
            <p className="mt-2 text-[10px] uppercase tracking-[0.22em] text-[#cfb580]/40">Coverage</p>
          </div>
          <div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-20 md:py-28 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold leading-snug">
            Dynamic coverage for one of sport&rsquo;s fastest-growing leagues.
          </h2>
        </div>
        <div className="text-[#cfb580]/70 text-base leading-relaxed space-y-5">
          <p>
            We partnered with the Professional Pickleball Association to produce high-energy event coverage and social content that captures the pace and excitement of the sport.
          </p>
          <p>
            Our work focused on creating content that connects with both dedicated fans and newcomers to the game — helping PPA grow its digital presence and showcase the elite level of play at their events.
          </p>
        </div>
      </section>
